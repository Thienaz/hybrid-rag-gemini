...
# =============================================================================
INTENT_PATTERNS = {
    # 1. BẮT CÁC CÂU HỎI SỰ THẬT (FACTUAL) / ĐỊNH NGHĨA
    "DINH_NGHIA": [
        "là gì", "nghĩa là", "khái niệm", "định nghĩa",
        "giải thích", "có nghĩa", "hiểu thế nào", "được hiểu là",
        "what is", "define", "explain", "meaning",
        "hãy cho biết", "em muốn biết", "thế nào là", "gọi là gì",
        # Các Keyword bóc tách thực thể từ bộ Demo Factual:
        "bộ phận nào", "thành phần nào", "hệ thống nào", 
        "mẫu thiết kế nào", "cấu trúc dữ liệu nào", "thuật toán nào", 
        "tính chất nào", "lệnh nào", "thư viện nào", "loại dữ liệu nào"
    ],
    
    # 2. BẮT CÁC CÂU HỎI SO SÁNH / ĐỐI CHIẾU (COMPARATIVE)
    "SO_SANH": [
        ...
        "tốt hơn", "kém hơn",
        # Các Keyword đối chiếu từ bộ Demo Comparative:
        "sự khác biệt", "vượt trội hơn", "sự đánh đổi", "thay vì"
    ],
    
    # 3. BẮT CÁC CÂU HỎI TÓM TẮT / PHÂN TÍCH TỔNG HỢP (MULTI-HOP)
    "TOM_TAT": [
        "tóm tắt", "tổng kết", "tổng hợp", "liệt kê",
        "các ý chính", "điểm chính", "nội dung chính",
        "summarize", "summary", "overview",
        "trình bày ngắn gọn", "nêu các", "kể tên",
        # Các Keyword phân tích cấp cao từ bộ Demo Multi-hop:
        "hãy phân tích", "phân tích", "vai trò", "chức năng chính"
    ],
    
    # 4. (MỚI) BẮT CÁC CÂU HỎI ỨNG DỤNG / TÌNH HUỐNG (APPLIED)
    "UNG_DUNG": [
        # Các Keyword giải quyết vấn đề từ bộ Demo Applied:
        "tại sao", "vì sao", "lý do gì", 
        "nên chọn", "sử dụng để", "được sử dụng để", "dùng để",
        "làm thế nào", "cách nào", "xảy ra trên", "tương tác"
    ]
}
